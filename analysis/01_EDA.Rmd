...
ggplot(banana_data, aes(x = factor(column), y = factor(row), fill = factor(color))) +
  geom_tile(color = "white") +  # Create the heatmap tiles
  scale_fill_viridis_d(name = "Color Scale", option = "C", direction = -1) +  # Use a nice color scale (viridis)
  labs(
    title = "Heatmap of Banana Ripeness (Color Scale) Over Row and Column",
...
taste_long_df <- banana_data %>%
  select(ID, row, column, taste_1, taste_2, taste_3, taste_avg) %>%
...
ggplot(taste_long_df, aes(x = factor(column), y = factor(row), fill = Taste)) +
  geom_tile(color = "white") +  # Create the heatmap tiles
  scale_fill_viridis_c(name = "Taste Rating", option = "C", direction = 1) +  # Color scale
  labs(
...
ggplot(avg_long_df, aes(x = liquid_treatment, y = hole_treatment, fill = Taste)) +
  geom_tile(color = "white") +  # Create the heatmap tiles
  scale_fill_viridis_c(name = "Average Taste", option = "C", direction = 1) +  # Color scale for average taste
  labs(
...
ggplot(avg_by_treatment, aes(x = liquid_treatment, y = hole_treatment, fill = avg_color)) +
  geom_tile(color = "white") +  # Create the heatmap tiles
  scale_fill_viridis_c(name = "Average Color", option = "C", direction = -1) +  # Color scale for average color
  labs(
...
# Bar plot for average taste ratings by hole treatment (treatment vs control)
ggplot(avg_long_df, aes(x = hole_treatment, y = Taste, fill = hole_treatment)) +
  geom_bar(stat = "identity", position = "dodge") +  # Bar chart
  scale_fill_manual(values = c("NH" = "blue", "H" = "red"), name = "Treatment") +  # Custom colors for control and treatment
  labs(
...
ggplot(avg_by_treatment, aes(x = hole_treatment, y = avg_color, fill = hole_treatment)) +
  geom_bar(stat = "identity", position = "dodge") +  # Bar chart
  scale_fill_manual(values = c("NH" = "blue", "H" = "red"), name = "Treatment") +  # Custom colors for control and treatment
  labs(
...
ggplot(avg_long_df, aes(x = liquid_treatment, y = Taste, fill = liquid_treatment)) +
  geom_bar(stat = "identity", position = "dodge") +  # Bar chart
  scale_fill_manual(values = c("NL" = "green", "DC" = "purple", "M" = "orange"), name = "Liquid Treatment") +  # Custom colors for liquid treatment
  labs(
...
ggplot(avg_by_treatment, aes(x = liquid_treatment, y = avg_color, fill = liquid_treatment)) +
  geom_bar(stat = "identity", position = "dodge") +  # Bar chart
  scale_fill_manual(values = c("NL" = "green", "DC" = "purple", "M" = "orange"), name = "Liquid Treatment") +  # Custom colors for liquid treatment
  labs(
